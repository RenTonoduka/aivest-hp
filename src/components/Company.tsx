export function Company() {
  ...
  return (
    <section id="company" className="relative py-28 lg:py-36">
      ...
      <div className="absolute top-0 left-1/4 w-[400px] h-[400px] blob-blue rounded-full opacity-30" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
            会社<span className="gradient-text-blue-green">概要</span>
          </h2>
        </div>
        ...
        <div className="max-w-3xl mx-auto glass-card rounded-2xl p-8 lg:p-12">
          <div className="divide-y divide-foreground/5">
            {info.map((item) => (
              ...
              >
                <dt className="text-sm font-semibold text-foreground/40 sm:w-40 flex-shrink-0 mb-1 sm:mb-0">
                  {item.label}
                </dt>
