...
const services = [
  ...
  },
  {
    ...
    gradient: "from-warmth-dark to-warmth",
  },
  {
    Icon: Terminal,
    title: "Claude Code 実践研修",
    description: "AIコーディングツールで開発生産性を劇的に向上。",
    gradient: "from-logic to-warmth-dark",
  },
  {
    Icon: Users,
    title: "AIエージェント導入顧問",
    description: "AI導入の戦略設計から運用定着まで経営目線で伴走。",
    gradient: "from-warmth-dark to-logic",
  },
];
...
export function ServicesOverview() {
  return (
    <section className="relative py-28 lg:py-36">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] blob-warmth rounded-full opacity-50" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] blob-logic rounded-full opacity-50" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <Link
            href="/services"
            className="inline-flex items-center gap-2 text-sm font-semibold text-logic hover:text-warmth transition-colors"
          >
            サービス詳細を見る
