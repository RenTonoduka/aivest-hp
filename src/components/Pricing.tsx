          ...
          {plans.map((plan) => (
            <div
              ...
              className={`glass-card rounded-2xl overflow-hidden ${
                plan.featured ? "ring-2 ring-warmth/30 lg:scale-105" : ""
              }`}
            >
              {plan.featured && (
                <div className="bg-gradient-to-r from-warmth to-warmth-light text-center py-1.5">
              ...
              <div className="p-7">
                ...
                <a
                  ...
                  className={`block text-center text-sm font-semibold py-3 rounded-xl transition-colors ${
                    plan.featured
                      ? "btn-primary"
                      : "border border-logic/12 text-logic hover:bg-logic/5"
                  }`}
                >
